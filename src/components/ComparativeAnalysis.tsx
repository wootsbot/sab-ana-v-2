  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-p-md items-stretch">
        ...
        {/* ========================================================= */}
        <div className="lg:col-span-3 flex flex-col gap-p-sm justify-start">
          ...
          <div className="flex flex-col gap-p-xs">
            ...
            <div 
              ...
              className={`py-2 px-2.5 rounded-sm border transition-all duration-100 cursor-pointer flex items-center justify-between gap-1.5 ${
            ...
            >
              <div className="flex items-center gap-1.5 min-w-0">
                <span className={`w-2.5 h-2.5 rounded-full shrink-0 ${COHORT_SPECS.intensivo.color}`} />
                <div className="flex flex-col min-w-0">
                  <span className="text-xs font-semibold text-neutral-raw-800 truncate">Intensivos</span>
                  <span className="text-[10px] text-neutral-raw-500 font-normal truncate">&gt; 20 consultas</span>
                </div>
              </div>
              <div className="flex flex-col items-end shrink-0 leading-tight">
                <span className="text-xs font-bold text-brand-700">{activeFocusPercentages.intensivo}%</span>
                <span className="text-[9px] text-neutral-raw-400 font-medium">
            ...
            >
              <div className="flex items-center gap-1.5 min-w-0">
                <span className={`w-2.5 h-2.5 rounded-full shrink-0 ${COHORT_SPECS.regular.color}`} />
                <div className="flex flex-col min-w-0">
                  <span className="text-xs font-semibold text-neutral-raw-800 truncate">Regulares</span>
                  <span className="text-[10px] text-neutral-raw-500 font-normal truncate">10-20 consultas</span>
                </div>
              </div>
              <div className="flex flex-col items-end shrink-0 leading-tight">
                <span className="text-xs font-bold text-sky-700">{activeFocusPercentages.regular}%</span>
                <span className="text-[9px] text-neutral-raw-400 font-medium">
            ...
            >
              <div className="flex items-center gap-1.5 min-w-0">
                <span className={`w-2.5 h-2.5 rounded-full shrink-0 ${COHORT_SPECS.ocasional.color}`} />
                <div className="flex flex-col min-w-0">
                  <span className="text-xs font-semibold text-neutral-raw-800 truncate">Ocasionales</span>
                  <span className="text-[10px] text-neutral-raw-500 font-normal truncate">1-10 consultas</span>
                </div>
              </div>
              <div className="flex flex-col items-end shrink-0 leading-tight">
                <span className="text-xs font-bold text-slate-700">{activeFocusPercentages.ocasional}%</span>
                <span className="text-[9px] text-neutral-raw-400 font-medium">
            ...
            >
              <div className="flex items-center gap-1.5 min-w-0">
                <span className={`w-2.5 h-2.5 rounded-full shrink-0 ${COHORT_SPECS.inactivo.color}`} />
                <div className="flex flex-col min-w-0">
                  <span className="text-xs font-semibold text-neutral-raw-800 truncate">Inactivos</span>
                  <span className="text-[10px] text-neutral-raw-500 font-normal truncate">0 consultas</span>
                </div>
              </div>
              <div className="flex flex-col items-end shrink-0 leading-tight">
                <span className="text-xs font-bold text-slate-600">{activeFocusPercentages.inactivo}%</span>
                <span className="text-[9px] text-neutral-raw-400 font-medium">
        ...
        {/* ========================================================= */}
        <div id="stacked-percent-barchart-column" className="lg:col-span-9 flex flex-col gap-p-sm border-t lg:border-t-0 lg:border-l border-neutral-raw-600/20 pt-p-md lg:pt-0 lg:pl-p-md">
