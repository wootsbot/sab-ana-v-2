...
export default function App() {
  ...
  const filteredAppsForList = useMemo(() => {
    ...
    const activeArea = currentData.topAreas.find(a => a.name === selectedHeatmapArea);
    const totalAreaUsers = activeArea ? activeArea.totalUsers : 1248;
    ...
    return listApps
      ...
      .map((app, index) => {
        ...
        const totalUsers = Math.round(totalAreaUsers * (percentage / 100));
        return {
          ...app,
          percentage,
          totalUsers
